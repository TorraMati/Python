...
# Luego, convierte cada número en la lista a string y únelos en una sola cadena, separados por guiones ('-'). 
# Sin embargo, excluye cualquier número que sea múltiplo de 3 de la cadena final.

entrada = input("Ingresa una lista de numeros separada por espacios: ")
